...
class VerificationKey:
    ...
    def verify_proof(self, group_order: int, pf, public=[]) -> bool:
        ...
        self.beta, self.gamma, self.alpha, self.zeta, self.v, self.u = self.compute_challenges(
            pf)
        ...
        E_pt = ec_mul(b.G1, (
            ...
            self.v**4 * flat_proof["s1_eval"] + self.v**5 *
            flat_proof["s2_eval"] + self.u * flat_proof["z_shifted_eval"]
        ))
